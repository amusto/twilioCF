<cfset getUsers = application.users.getUsers(session.orgId)>
						...
						<table class="data" width="100%" cellpadding="0" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td>#MYDATETIME#</td>
									<td>
										<a href="/modal_window.html" id="shortcut_contacts" title="Click me to open modal window"><img src="/images/icon_edit.png" alt="edit" class="help" title="Edit"/></a>
